...
ADDITIONAL_STOCKS = [
    'DVL', 'KKCL', 'DCMSHRIRAM', 'MODIRUBBER', 'CAPITALSFB', 'SPECTRUM', 'AIAENG', 'FOSECOIND',
    'LIBERTSHOE', 'HEUBACHIND', 'SHIVATEX', 'AARTISURF', 'NILKAMAL', 'INDOTHAI', 'ASAL', 'SMARTWORKS',
    'LAMBODHARA', 'SASKEN', 'SAHYADRI', 'TRF', 'HATSUN', 'ADVENTHTL', 'HIRECT', 'FMGOETZE',
    'MEDICAMEQ', 'SOTL', 'DOMS', 'JCHAC', 'NITINSPIN', 'KIRLOSBROS', 'GILLETTE', 'AXISCADES',
    'POKARNA', 'INDOTECH', 'BHARATGEAR', 'KEI', 'RPTECH', 'EIHAHOTELS', 'SEMAC', 'TRANSWORLD'
]
